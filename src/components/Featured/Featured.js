    ...
    <div className={classes.container}>
      ...
      <div className={classes.blackCustomerExperience}>
        ...
        <di className={classes.blackGirlsExperience}>
          ...
          <div className={classes.customerTag}>CUSTOMER</div>
          <p className={classes.blackGirlsExperienceMessage}>
            ...
            all round great experience. I would definately be coming back! I had
            the best experience shopping with vasiti. Usability of the website
      ...
      <div className={classes.vendorExperience}>
        <div className={classes.blackGirlsExperience}>
          ...
          <div className={classes.vendorTag}>VENDOR</div>
